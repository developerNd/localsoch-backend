...
async function setupPermissionsAndSeed() {
  try {
    console.log('🔧 Setting up permissions and seeding data...');
    ...
    // Step 3: Set up permissions for Public role
    console.log('\n🔐 Step 3: Setting up permissions for Public role...');
    try {
...
// Run the setup
setupPermissionsAndSeed().then(success => {
  if (success) {
