...
export interface ApiAnalyticsAnalytics extends Struct.CollectionTypeSchema {
  collectionName: 'analytics_dashboard';
  info: {
    description: 'Dashboard analytics and statistics';
    displayName: 'Dashboard Analytics';
    pluralName: 'dashboard-analytics';
  ...
  attributes: {
    ...
    totalSellers: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Promotional banners for the home screen';
    displayName: 'Banner';
    pluralName: 'banners';
    singularName: 'banner';
  };
  ...
  attributes: {
    actionData: Schema.Attribute.JSON;
    ...
    backgroundColor: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#14b8a6'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    targetAudience: Schema.Attribute.Enumeration<
      ['all', 'new_users', 'returning_users', 'premium_users']
    > &
...
export interface ApiBusinessCategoryBusinessCategory
  ...
  info: {
    description: 'Business categories for seller registration';
...
export interface ApiFeaturedProductFeaturedProduct
  ...
  info: {
    description: 'Featured products for the home screen';
  ...
  attributes: {
    ...
    discountPercentage: Schema.Attribute.Integer &
      ...
      >;
    endDate: Schema.Attribute.DateTime;
    featuredType: Schema.Attribute.Enumeration<
      ['featured', 'trending', 'new_arrival', 'best_seller', 'flash_sale']
    > &
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    pickupAddress: Schema.Attribute.JSON;
    pickupTime: Schema.Attribute.String;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    approvalReason: Schema.Attribute.Text;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customCategory: Schema.Attribute.String;
    description: Schema.Attribute.Text;
...
export interface ApiReferralReferral extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Referral system for tracking user referrals and rewards';
  ...
  attributes: {
    ...
    referrer: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    rewardAmount: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<50>;
...
export interface ApiSubscriptionPlanSubscriptionPlan
  ...
  info: {
    description: 'Available subscription plans for sellers';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    maxOrders: Schema.Attribute.Integer;
    maxProducts: Schema.Attribute.Integer;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    sortOrder: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiSubscriptionSubscription
  ...
  info: {
    description: 'Seller subscription plans and payments';
...
export interface ApiVendorVendor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    buttonClickLogs: Schema.Attribute.Relation<
      'oneToMany',
      'api::button-click-log.button-click-log'
    >;
    buttonClicks: Schema.Attribute.Component<'vendor.button-clicks', false>;
    buttonConfig: Schema.Attribute.Component<'vendor.button-config', false>;
    ...
    > &
      Schema.Attribute.DefaultTo<'pending'>;
    statusReason: Schema.Attribute.Text;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    referredBy: Schema.Attribute.Relation<'oneToOne', 'api::referral.referral'>;
    resetPasswordToken: Schema.Attribute.String & Schema.Attribute.Private;
    role: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.role'
    >;
    totalRewards: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    username: Schema.Attribute.String &
